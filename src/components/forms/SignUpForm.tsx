...
const authInputClass = 'rounded-xl h-11 bg-background border-border text-foreground';
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5 w-full">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            <div
              className={`p-2 rounded-full ${
                form.watch('userType') === 'TENANT' ? 'bg-primary/15' : 'bg-muted'
              }`}
            >
              <User size={24} />
            </div>
          ...
          >
            <div
              className={`p-2 rounded-full ${
                form.watch('userType') === 'LANDLORD' ? 'bg-primary/15' : 'bg-muted'
              }`}
            >
              <Home size={24} />
            </div>
