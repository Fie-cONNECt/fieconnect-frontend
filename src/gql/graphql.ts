...
export type MyApplicationsQuery = { __typename?: 'Query', myApplications: Array<{ __typename?: 'Application', id: string, status: string, createdAt: string, property: { __typename?: 'Property', id: string } }> };
