...
export type MeQuery = { __typename?: 'Query', me?: { __typename?: 'User', id: string, firstName: string, lastName: string, email: string, userType: string, phone: string, avatarUrl?: string | null, bio?: string | null, createdAt: string, savedProperties: Array<{ __typename?: 'Property', id: string }> } | null };
