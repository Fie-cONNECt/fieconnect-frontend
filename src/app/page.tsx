...
const FEATURES = [
  {
    ...
    description: 'Every landlord and property is vetted, so you rent with confidence and zero surprises.',
  },
  {
    icon: FileCheck2,
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { icon: FileCheck2, value: '3 min', label: 'Avg. Time to List' },
      ...
      <section className="w-full bg-muted/40 border-y border-border">
        <div className="page-container py-16 sm:py-20">
          <div className="max-w-2xl mx-auto text-center space-y-3 mb-12">
            ...
            <p className="text-body text-muted-foreground">
              Real stories from people who found their home or filled their properties on FieConnect.
            </p>
          </div>
