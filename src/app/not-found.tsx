  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 page-container flex flex-col items-center justify-center text-center py-16">
        ...
        <h1 className="text-display text-foreground max-w-lg">This page could not be found</h1>
        <p className="text-body text-muted-foreground mt-4 max-w-md">
          The link may be broken or the page may have been moved. Head back home or browse available
          rentals.
        </p>
        <div className="flex flex-wrap items-center justify-center gap-3 mt-8">
          <Link
            href="/"
            className={cn(buttonVariants({ size: 'lg' }), 'rounded-xl font-semibold gap-2')}
          >
